...
import { useNewTrailersFetchQuery } from "../api/use-new-trailers-fetch-query";
  ...
  return (
    <ContainerUI>
      <StyledSlider data-testid="sliderWithNewTrailer">
        {!loadingFetchTrailers && dataFetchTrailers?.length === 0 && <ErrorStateUI content={ERROR_MESSAGE} />}
